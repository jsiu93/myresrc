...
public class SysRoleMenu extends TableImpl<SysRoleMenuRecord> {
    ...
    private static final long serialVersionUID = 1853296480;

    /**
     * The reference instance of <code>myresrc_admin.sys_role_menu</code>
     */
    ...
    /**
     * The column <code>myresrc_admin.sys_role_menu.id</code>.
     */
    ...
    /**
     * Create an aliased <code>myresrc_admin.sys_role_menu</code> table reference
     */
    ...
    private SysRoleMenu(Name alias, Table<SysRoleMenuRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("角色与菜单对应关系"));
    }
